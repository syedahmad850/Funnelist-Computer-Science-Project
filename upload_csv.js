...
// DIR name resolved in ES module
var __filename = (0, url_1.fileURLToPath)(import.meta.url);
var __dirname = path_1.default.dirname(__filename);
// JSON import for ES Module
var firebase_adminsdk_json_1 = require("../firebase-adminsdk.json");
// Firebase admin sdk initiated
firebase_admin_1.default.initializeApp({
    credential: firebase_admin_1.default.credential.cert({
        ...
        privateKey: firebase_adminsdk_json_1.default.private_key.replace(/\\n/g, "\n"), // Fix for multiline private keys
    }),
});
var db = firebase_admin_1.default.firestore();
var leadsCollection = db.collection("leads");
// Function to upload CSV data
var uploadCSV = function () { return __awaiter(void 0, void 0, void 0, function () {
    var filePath;
    return __generator(this, function (_a) {
        filePath = path_1.default.join(__dirname, "../ddata.csv");
        fs_1.default.createReadStream(filePath)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, leadsCollection.add(row)];
                    case 1:
                        _a.sent();
                        console.log("Uploaded: ".concat(row.Name));
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
